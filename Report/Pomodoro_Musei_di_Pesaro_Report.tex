...
\begin{document}
	\begin{flushleft}
		...
		\bigskip
		Sono stati inoltre rilasciati altri materiali a supporto dei visitatori del museo, come: 
		...
		\begin{itemize}
			...
			\item Un album di figurine riguardo le opere dei Musi Civici (indirizzato ai bambini) raggiungibile a \href{https://github.com/Pomodoro-Musei-di-Pesaro/Pesaro-Museums-stickers-Album}{\textcolor{blue}{questo link}}.
			\item Un quaderno per prendere appunti all'interno del museo (rivolto ai bambini) raggiungibile a \href{https://github.com/Pomodoro-Musei-di-Pesaro/Pesaro-Museums-Notebook}{\textcolor{blue}{questo link}}.
		\end{itemize}
